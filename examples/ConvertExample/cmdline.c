...
const char *cmdline_parser_input_format_values[] = {"hepmc2", "auto", "hepmc3", "hpe", "root", "treeroot", "lhef", "uproot", "plugin", "proto", "hdf5", 0}; /*< Possible values for input-format. */
const char *cmdline_parser_output_format_values[] = {"hepmc2", "hepmc3", "hpe", "root", "treeroot", "treerootopal", "hpezeus", "dump", "plugin", "dot", "none", "proto", "hdf5", 0}; /*< Possible values for output-format. */
