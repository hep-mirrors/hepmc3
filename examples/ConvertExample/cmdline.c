/*
  ...
  /usr/bin/gengetopt -N --no-version --input=/data/andriish/Projects/HepMC3/examples/ConvertExample/cmdline.ggo --file-name cmdline --output-dir=/data/andriish/Projects/HepMC3/examples/ConvertExample --include-getopt --show-required --unnamed-opts=inputfile outputfile 
...
const char *cmdline_parser_input_format_values[] = {"hepmc2", "auto", "hepmc3", "hpe", "root", "treeroot", "lhef", "plugin", "proto", "oscar1997", "oscar1999", "oscar2013", 0}; /*< Possible values for input-format. */
const char *cmdline_parser_output_format_values[] = {"hepmc2", "hepmc3", "hpe", "root", "treeroot", "treerootopal", "hpezeus", "dump", "plugin", "dot", "none", "proto", "oscar1997", "oscar1999", "oscar2013", 0}; /*< Possible values for output-format. */
