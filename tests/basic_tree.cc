...
int main() {
    ...
    GenParticle p1( FourVector(0,0,7000,700),                2212, 3 );
    GenParticle p2( FourVector(0,0,-7000,700),               2212, 3 );
    GenParticle p3( FourVector(.750,-1.569,32.191,32.238),   1,    3 );
    GenParticle p4( FourVector(-3.047,-19.,-54.629,57.920), -2,    3 );
    ...
    GenParticle p5( FourVector(-3.813,0.113,-1.833,4.233 ),   22, 1 );
    GenParticle p6( FourVector(1.517,-20.68,-20.605,85.925), -24, 3 );
    ...
    GenParticle p7( FourVector(-2.445,28.816,6.082,29.552),    1, 1 );
    GenParticle p8( FourVector(3.962,-49.498,-26.687,56.373), -2, 1 );
