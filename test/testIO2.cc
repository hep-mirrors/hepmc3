...
int main()
{
    HepMC::ReaderAsciiHepMC2* inputA =new HepMC::ReaderAsciiHepMC2("inputIO2.hepmc");
    if(inputA->failed()) return 1;
    HepMC::WriterRootTree*       outputA=new HepMC::WriterRootTree("frominputIO2.root");
    ...
    HepMC::ReaderRootTree* inputB =new HepMC::ReaderRootTree("frominputIO2.root");
    if(inputB->failed()) return 3;
    HepMC::WriterAsciiHepMC2*       outputB=new HepMC::WriterAsciiHepMC2("fromfrominputIO2.hepmc");
