...
void bind_pyHepMC3_8(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // HepMC3::GenEvent file:HepMC3/GenEvent.h line:41
		...
		cl.def("event_number", (long (HepMC3::GenEvent::*)() const) &HepMC3::GenEvent::event_number, "Get event number\n\nC++: HepMC3::GenEvent::event_number() const --> long");
		cl.def("set_event_number", (void (HepMC3::GenEvent::*)(const long &)) &HepMC3::GenEvent::set_event_number, "Set event number\n\nC++: HepMC3::GenEvent::set_event_number(const long &) --> void", pybind11::arg("num"));
