...
void bind_pyHepMC3_10(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	{ // HepMC3::GenParticle file:HepMC3/GenParticle.h line:28
		...
		cl.def("parents", (class std::list<class std::shared_ptr<class HepMC3::GenParticle> > (HepMC3::GenParticle::*)()) &HepMC3::GenParticle::parents, "Convenience access to immediate incoming particles via production vertex\n \n\n Less efficient than via the vertex since return must be by value (in case there is no vertex)\n\nC++: HepMC3::GenParticle::parents() --> class std::list<class std::shared_ptr<class HepMC3::GenParticle> >");
		cl.def("children", (class std::list<class std::shared_ptr<class HepMC3::GenParticle> > (HepMC3::GenParticle::*)()) &HepMC3::GenParticle::children, "Convenience access to immediate outgoing particles via end vertex\n \n\n Less efficient than via the vertex since return must be by value (in case there is no vertex)\n\nC++: HepMC3::GenParticle::children() --> class std::list<class std::shared_ptr<class HepMC3::GenParticle> >");
	...
	{ // HepMC3::GenVertexData file: line:22
		...
		cl.def_readwrite("id", &HepMC3::GenVertexData::id);
	...
	{ // HepMC3::GenVertex file:HepMC3/GenVertex.h line:25
		...
		cl.def("particles_in", (const class std::list<class std::shared_ptr<class HepMC3::GenParticle> > & (HepMC3::GenVertex::*)()) &HepMC3::GenVertex::particles_in, "Get list of incoming particles\n\nC++: HepMC3::GenVertex::particles_in() --> const class std::list<class std::shared_ptr<class HepMC3::GenParticle> > &", pybind11::return_value_policy::automatic);
		cl.def("particles_out", (const class std::list<class std::shared_ptr<class HepMC3::GenParticle> > & (HepMC3::GenVertex::*)()) &HepMC3::GenVertex::particles_out, "Get list of outgoing particles\n\nC++: HepMC3::GenVertex::particles_out() --> const class std::list<class std::shared_ptr<class HepMC3::GenParticle> > &", pybind11::return_value_policy::automatic);
