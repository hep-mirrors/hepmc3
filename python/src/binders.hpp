...
void	print_binder(pybind11::module &M)
	...
	{ // HepMC3::Print file: line:27
		...
		cl.def_static("line", [](pybind11::object  & a0, const struct HepMC3::FourVector & a1) -> void {  std::stringstream b; HepMC3::Print::line(b, a1);   a0.attr("write")(pybind11::str(b.str().c_str()));  }, "Print one-line info\n\nC++: HepMC3::Print::line(std::ostream &, const class HepMC3::FourVector &) --> void", pybind11::arg("os"), pybind11::arg("p"));
