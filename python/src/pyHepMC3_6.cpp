...
void bind_pyHepMC3_6(std::function< pybind11::module &(std::string const &namespace_) > &M)
{
	...
	{ // HepMC3::GenEvent file:HepMC3/GenEvent.h line:
		...
		cl.def("add_attributes", (void (HepMC3::GenEvent::*)(const class std::vector<std::string > &, const class std::vector<class std::shared_ptr<class HepMC3::Attribute> > &, const class std::vector<int> &)) &HepMC3::GenEvent::add_attributes, "Add multiple attributes to event\n\n This will overwrite existing attributes if attributes\n with the same names are present\n\nC++: HepMC3::GenEvent::add_attributes(const class std::vector<std::string > &, const class std::vector<class std::shared_ptr<class HepMC3::Attribute> > &, const class std::vector<int> &) --> void", pybind11::arg("names"), pybind11::arg("atts"), pybind11::arg("ids"));
		cl.def("add_attributes", (void (HepMC3::GenEvent::*)(const std::string &, const class std::vector<class std::shared_ptr<class HepMC3::Attribute> > &, const class std::vector<int> &)) &HepMC3::GenEvent::add_attributes, "Add multiple attributes to event\n\n This will overwrite existing attributes if attributes\n with the same names are present\n\nC++: HepMC3::GenEvent::add_attributes(const std::string &, const class std::vector<class std::shared_ptr<class HepMC3::Attribute> > &, const class std::vector<int> &) --> void", pybind11::arg("name"), pybind11::arg("atts"), pybind11::arg("ids"));
		cl.def("add_attributes", (void (HepMC3::GenEvent::*)(const std::string &, const class std::vector<struct std::pair<int, class std::shared_ptr<class HepMC3::Attribute> > > &)) &HepMC3::GenEvent::add_attributes, "Add multiple attributes to event\n\n This will overwrite existing attributes if attributes\n with the same names are present\n\nC++: HepMC3::GenEvent::add_attributes(const std::string &, const class std::vector<struct std::pair<int, class std::shared_ptr<class HepMC3::Attribute> > > &) --> void", pybind11::arg("name"), pybind11::arg("atts"));
