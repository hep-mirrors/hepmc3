...
{
	{ // HepMC3::HEPEVT_Pointers file: line:62
	...
	{ // HepMC3::GenParticlePtr_greater file: line:75
	...
	{ // HepMC3::pair_GenVertexPtr_int_greater file: line:81
	...
	// HepMC3::calculate_longest_path_to_top(class std::shared_ptr<const class HepMC3::GenVertex>, class std::map<class std::shared_ptr<const class HepMC3::GenVertex>, int> &) file: line:88
	...
	// HepMC3::HEPEVT_to_GenEvent_nonstatic(class HepMC3::GenEvent *, const class HepMC3::HEPEVT_Wrapper_Runtime *) file: line:93
	...
	// HepMC3::GenEvent_to_HEPEVT_nonstatic(const class HepMC3::GenEvent *, class HepMC3::HEPEVT_Wrapper_Runtime *) file: line:163
