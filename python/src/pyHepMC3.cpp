...
//WIN		cl.def("insert", (struct std::pair<struct std::_Rb_tree_const_iterator<long>, bool> (std::set<long>::*)(const long &)) &std::set<long, std::less<long>, std::allocator<long> >::insert, "C++: std::set<long, std::less<long>, std::allocator<long> >::insert(const long &) --> struct std::pair<struct std::_Rb_tree_const_iterator<long>, bool>", pybind11::arg("__x"));
//WIN		cl.def("erase", (unsigned long (std::set<long>::*)(const long &)) &std::set<long, std::less<long>, std::allocator<long> >::erase, "C++: std::set<long, std::less<long>, std::allocator<long> >::erase(const long &) --> unsigned long", pybind11::arg("__x"));
//WIN		cl.def("clear", (void (std::set<long>::*)()) &std::set<long, std::less<long>, std::allocator<long> >::clear, "C++: std::set<long, std::less<long>, std::allocator<long> >::clear() --> void");
//WIN		cl.def("count", (unsigned long (std::set<long>::*)(const long &) const) &std::set<long, std::less<long>, std::allocator<long> >::count, "C++: std::set<long, std::less<long>, std::allocator<long> >::count(const long &) const --> unsigned long", pybind11::arg("__x"));
//WIN		cl.def("equal_range", (struct std::pair<struct std::_Rb_tree_const_iterator<long>, struct std::_Rb_tree_const_iterator<long> > (std::set<long>::*)(const long &)) &std::set<long, std::less<long>, std::allocator<long> >::equal_range, "C++: std::set<long, std::less<long>, std::allocator<long> >::equal_range(const long &) --> struct std::pair<struct std::_Rb_tree_const_iterator<long>, struct std::_Rb_tree_const_iterator<long> >", pybind11::arg("__x"));
	}
}
